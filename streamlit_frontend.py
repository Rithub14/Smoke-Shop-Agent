...
from vector_store import SmokeShopVectorStore
from chatbot import app
from langchain_core.messages import AIMessage, HumanMessage
from tools import customers_database, data_protection_checks


st.set_page_config(layout='wide', page_title='Smoke Shop Chatbot', page_icon='000')

if 'message_history' not in st.session_state:
    st.session_state.message_history = [AIMessage(content="Hiya, Im the Smoke shop chatbot. How can I help?")]
